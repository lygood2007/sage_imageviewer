...
viewer_server: viewer_server.o server.o funcs.o server_scene.o image_loader.o
	$(CXX) viewer_server.o server.o funcs.o server_scene.o image_loader.o -o viewer_server $(LIBS)
...
server_scene.o:
	$(CXX) $(DEBUGFLAGS) -c server_scene.cpp $(CFLAGS) $(LIBS)
clean:
